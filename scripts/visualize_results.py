...
Displays charts in pop-up windows
"""
...
def main():
    ...
    print("Close each plot window to view the next visualization.\n")

    print("1️⃣  Displaying: CHURN vs RETENTION ANALYSIS")
    visualize_churn_distribution(predictions_df, summary)

    print("2️⃣  Displaying: RISK LEVEL ANALYSIS")
    visualize_risk_levels(predictions_df)

    print("3️⃣  Displaying: CHURN PROBABILITY ANALYSIS")
    visualize_churn_probability(predictions_df)

    print("4️⃣  Displaying: MODEL PERFORMANCE METRICS")
    visualize_model_performance(evaluation)

    print("5️⃣  Displaying: PREDICTION SUMMARY STATISTICS")
    visualize_summary_stats(summary)

    print("6️⃣  Displaying: COMPREHENSIVE DASHBOARD")
